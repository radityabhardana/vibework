...
export async function POST(req: Request) {
  ...
  try {
    ...
    lease = acquireGenerationLease(projectId, 'prompts');
    ...
    const committedRevision = withFencedGenerationCommit(lease, (tx) => {
      ...
      return tx.select({ specRevision: projects.specRevision })
        .from(projects)
